...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'json_file_path',               'default': "'/home/olivas/camera_ws/src/realsense-ros/realsense2_camera/launch/test2.json'", 'description': 'allows advanced configuration'},
                           ...
                           {'name': 'depth_module.exposure',        'default': '', 'description': 'Depth module manual exposure value'},
